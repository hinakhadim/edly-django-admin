...
"""
edly-django-admin documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'edly-django-admin',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/edly-django-admin",
...
#
# html_title = 'edly-django-admin v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edly_django_admin'),
                os.path.join(root_path, 'edly_django_admin/migrations')])
