...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd edly_django_admin && i18n_tool extract --no-segment

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd edly_django_admin && i18n_tool generate

detect_changed_source_translations:
	cd edly_django_admin && i18n_tool changed
...
pull_translations:
	find edly_django_admin/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/edly-django-admin/edly_django_admin/conf/locale:edly_django_admin/conf/locale
...
dummy_translations: ## generate dummy translation (.po) files
	cd edly_django_admin && i18n_tool dummy
