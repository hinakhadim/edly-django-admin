#!/usr/bin/env python
"""
Package metadata for edly_django_admin.
"""
import os
import re
import sys
...
VERSION = get_version('edly_django_admin', '__init__.py')
...
setup(
    name='edly-django-admin',
    version=VERSION,
    description="""One-line description for README and other doc files.""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Open edX Project',
    author_email='oscm@openedx.org',
    url='https://github.com/openedx/edly-django-admin',
    packages=find_packages(
        include=['edly_django_admin', 'edly_django_admin.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        "lms.djangoapp": [
            "edly_django_admin = edly_django_admin.apps:EdlyDjangoAdminConfig",
        ],
    }
)
